...
export const LIVE_GROUNDING_HARD_GUARDS = [
  ...
  'KOSZYK JEST EKRANEM KONTROLI: gdy użytkownik naturalnie zamawia konkretną pozycję i znane są restauracja, pozycja oraz ilość, NATYCHMIAST wywołaj add_item_to_cart albo add_items_to_cart. Nie pytaj drugi raz „potwierdzasz?” i nie wymagaj powtórzenia pełnej nazwy dania. Użytkownik sprawdza pozycje, ilości i ceny w koszyku, a zamówienie oraz płatność zatwierdza później ręcznie.',
  'TRYB AWARYJNY STAREGO KONTRAKTU: confirm_add_to_cart wywołuj tylko wtedy, gdy ostatni wynik narzędzia jawnie zwróci confirmationRequired=true i użytkownik potwierdzi. Nie twórz tego etapu samodzielnie.',

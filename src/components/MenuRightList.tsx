        ...
        <AnimatePresence>
            ...
            >
                <div className="pointer-events-auto bg-black/40 backdrop-blur-xl border border-white/10 rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.3)] w-80 max-h-[50vh] flex flex-col overflow-hidden relative">
                    {/* Background Glow */}
                    <div className="absolute inset-0 bg-gradient-to-bl from-[var(--ff-amber-500)]/5 to-transparent pointer-events-none" />
                    ...
                    <div className="p-4 border-b border-white/10 bg-white/5 backdrop-blur-md sticky top-0 z-10 flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-[10px] text-[var(--ff-amber-500)] uppercase tracking-wider font-medium">Lista Dań</p>
                        </div>
                        <div className="w-6 h-6 rounded-full bg-white/5 flex items-center justify-center text-[var(--ff-amber-500)] text-xs">
                            🍽️
                        </div>
                    </div>
                    ...
                    <div className="overflow-y-auto p-2 tiny-scroll space-y-2">
                        {presentationItems.map((item: any, i: number) => (
                            <motion.div
                                ...
                                className="group p-3 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-[var(--ff-amber-500)]/30 hover:shadow-[0_0_15px_rgba(34,211,238,0.1)] transition-all cursor-pointer flex flex-col gap-1 relative overflow-hidden"
                            >
                                <div className="flex justify-between items-start gap-2">
                                    <span className="text-sm font-medium text-slate-200 group-hover:text-white transition-colors line-clamp-2">
                                        {item.name}
                                    </span>
                                    <span className="font-mono text-xs font-bold text-[var(--ff-amber-500)] bg-[var(--ff-amber-500)]/10 px-1.5 py-0.5 rounded whitespace-nowrap">
                                ...
                                <div className="absolute right-2 bottom-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <div className="w-6 h-6 rounded-full bg-[var(--ff-amber-500)] text-black flex items-center justify-center text-lg leading-none shadow-lg transform active:scale-90 transition-transform">
                                        +
                                    </div>
                                </div>
                            </motion.div>
